...
$all_questions= allQuestions($conn);
$no_of_all_questions = $all_questions->num_rows;
...
<div class="cards">
    ...
    <div class="card">
        <div class="card-text">
            <h2>All Questions</h2>
            <p class="card-no"><?php echo $no_of_all_questions?></p>
        </div>
        <div class="card-button">
            <a href="questions.all.php"> View More...</a>
        </div>
    </div>
